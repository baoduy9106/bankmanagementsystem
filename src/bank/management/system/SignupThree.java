...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        JLabel carddetails = new JLabel("Your 16 digit card numbers");
        carddetails.setFont(new Font("Raleway", Font.BOLD, 12));
        carddetails.setBounds(100, 270, 200, 14);
        add(carddetails);
        ...
        pindetails.setBounds(100, 330, 300, 14);
        add(pindetails);
        ...
        c7 = new JCheckBox("I here by declares that the above entered detailts are correct to the best knowledge");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            if (c1.isSelected()) {
                ...
                facility = facility + " Mobile Baking";
            ...
            try {
                if (accountType.equals("")) {
                    ...
                    setVisible(false);
                    new Deposit(pincode).setVisible(false);
                }
            } catch (Exception e) {
